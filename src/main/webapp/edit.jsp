        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <h2 class="text-center mb-4">Изменить пластинку</h2>
                    <form method="post" action="${pageContext.request.contextPath}/success-plate" class="flex-column d-flex gap-3 align-items-center">
                        <div class="form-group w-100">
                            <label for="inputName">Название:</label>
                            <input type="text" value="<%=plate.getName()%>" name="name" class="form-control" id="inputName" placeholder="Введите название">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputpreview">Превью:</label>
                            <input type="text" value="<%=plate.getPreview()%>" name="preview" class="form-control" id="inputpreview" placeholder="Введите url">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputDesc">Описание:</label>
                            <input type="text" value="<%=plate.getDescription()%>" class="form-control" name="desc" id="inputDesc" placeholder="Введите описание">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputPassword">Цена:</label>
                            <input type="number" min="0" name="price" value="<%=plate.getPrice()%>" class="form-control" id="inputPassword"
                                   placeholder="Введите цену">
                        </div>
                        <input type="hidden" name="id" value="<%=plate.getId()%>">
