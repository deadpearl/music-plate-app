        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <h2 class="text-center mb-4">Изменить пользователя</h2>
                    <form method="post" action="${pageContext.request.contextPath}/success-user" class="flex-column d-flex gap-3 align-items-center">
                        <div class="form-group w-100">
                            <label for="inputName">Имя:</label>
                            <input type="text" name="name" value="<%=user.getName()%>" class="form-control" id="inputName" placeholder="Введите имя">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputSur">Фамилия:</label>
                            <input type="text" name="surname" value="<%=user.getSurname()%>" class="form-control" id="inputSur" placeholder="Введите фамилию">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputEmail">Email:</label>
                            <input type="email" name="email" value="<%=user.getEmail()%>" class="form-control" id="inputEmail" placeholder="Введите email">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputPassword">Пароль:</label>
                            <input type="password" name="password" value="<%=user.getPassword()%>" class="form-control" id="inputPassword"
