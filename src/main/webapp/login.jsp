        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <form method="post" action="/entry" class="flex-column d-flex gap-3 align-items-center">
                        ...
                        <div class="d-flex justify-content-between w-100">
                            <div class="form-group form-check align-self-start">
                                <input type="checkbox" class="form-check-input" id="rememberMe">
                                <label class="form-check-label" for="rememberMe">Запомнить меня</label>
                            </div>
                            <a href="${pageContext.request.contextPath}/register" class="stretched-link">Зарегистрироваться
                            </a>
                        </div>
