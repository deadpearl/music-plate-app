        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <h2 class="text-center mb-4">Зарегистрироваться</h2>
                    <form method="post" action="/reg" class="flex-column d-flex gap-3 align-items-center">
                        ...
                        <div class="d-flex justify-content-end w-100">
                            <a href="${pageContext.request.contextPath}/login" class="stretched-link">Уже есть аккаунт?
                            </a>
                        </div>
