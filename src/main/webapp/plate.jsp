        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <h2 class="text-center mb-4">Создать пластинку</h2>
                    <form method="post" action="${pageContext.request.contextPath}/create-plate" class="flex-column d-flex gap-3 align-items-center">
                        ...
                        <div class="form-group w-100">
                            ...
                            <input type="text" name="preview" class="form-control" id="inputpreview" placeholder="Введите url">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputDesc">Описание:</label>
                            <input type="text" class="form-control" name="desc" id="inputDesc" placeholder="Введите описание">
                        </div>
                        <div class="form-group w-100">
                            <label for="inputPassword">Цена:</label>
                            <input type="number" min="0" name="price" class="form-control" id="inputPassword"
