...
//            }
    ...
    <main class="container my-5 flex-grow-1">
        <h1>О компании MUSIC</h1>
        <p>Мы - магазин музыкальных пластинок, предлагаем широкий ассортимент различных жанров и исполнителей. Наша
            компания была основана в 2010 году и с тех пор мы стараемся радовать наших клиентов качественной продукцией
            и отличным сервисом.</p>
        <p>Мы заботимся о том, чтобы наши покупатели получили именно то, что ищут, и всегда готовы помочь с выбором и
            ответить на любые вопросы.</p>
